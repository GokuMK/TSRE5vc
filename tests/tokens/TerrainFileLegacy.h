...
#ifndef TERRAIN_FILE_LEGACY_H
#define	TERRAIN_FILE_LEGACY_H

class TerrainFileLegacy {
public:
    ...
    TerrainFileLegacy();
    TerrainFileLegacy(const TerrainFileLegacy& orig);
    virtual ~TerrainFileLegacy();
...
private:
    ...
    void get153(FileBuffer* data, TerrainFileLegacy::Mat* m);
    void get156(FileBuffer* data, TerrainFileLegacy::Mat* m);
