...
void PickupObj::pushRenderItems(float lod, float posx, float posz, float* playerW, float* target, float fov, int selectionColor){
    if (!loaded)
        return;
...
void PickupObj::renderTritems(GLUU* gluu, int selectionColor, bool pushToQueue){
