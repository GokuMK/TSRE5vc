...
bool AceLibLegacy::IsThread = true;

AceLibLegacy::AceLibLegacy(){
...
bool AceLibLegacy::saveRgbChecked(const QString &path, const QImage &image, QString &error) {
